          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-lg gallery-shadow p-8 animate-slide-in-right" style={{ animationDelay: '0.9s' }}>
              ...
              <form className="space-y-6">
                ...
                <Button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-cormorant text-lg py-3 transition-all duration-300 hover:scale-105 hover:shadow-lg animate-bounce-in" style={{ animationDelay: '1.6s' }}>
                  Verstuur bericht
                </Button>
              </form>
            </div>
